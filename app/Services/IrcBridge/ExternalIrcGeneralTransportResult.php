...
final readonly class ExternalIrcGeneralTransportResult
{
    ...
    public static function shadowed(?int $responseCode = null, ?CarbonImmutable $submittedAt = null): self
    {
        return new self('shadowed', $responseCode, null, $submittedAt ?? CarbonImmutable::now());
    }
